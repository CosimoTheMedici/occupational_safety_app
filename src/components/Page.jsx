...
import { Bell, Home, Users } from 'react-feather'
        ...
        <div class="header header-one">
            <div class="header-left header-left-one">
                ...
                <a href="index.html" class="logo logo-small">
                    <img src={images.logo_small} alt="Logo" width="30" height="30"/>
                </a>
            </div>
            ...
            <ul class="nav nav-tabs user-menu">
                <li class="nav-item dropdown has-arrow flag-nav">
                    <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button">
                        <img src={images.us} alt="" height="20"/> <span>English</span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-right">
                        <a href="javascript:void(0);" class="dropdown-item">
                            <img src={images.us} alt="" height="16"/> English
                        </a>
                        <a href="javascript:void(0);" class="dropdown-item">
                            <img src={images.fr} alt="" height="16"/> French
                        </a>
                        <a href="javascript:void(0);" class="dropdown-item">
                            <img src={images.es} alt="" height="16"/> Spanish
                        </a>
                        <a href="javascript:void(0);" class="dropdown-item">
                            <img src= {images.de} alt="" height="16"/> German
                        </a>
                    </div>
                </li>
                ...
                <li class="nav-item dropdown">
                    <a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
                        <i data-feather="bell"><Bell /></i> <span class="badge rounded-pill">55</span>
                    </a>
            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="active">
                            <a href="index.html"><i><Home/></i> <span>Dashboard</span></a>
                        </li>
                        <li>
                            <a href="customers.html"><i data-feather="users"><Users/></i> <span>Customers</span></a>
                        </li>
                        <li>

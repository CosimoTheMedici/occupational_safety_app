...
const Navbar = () => {
    ...
    const divElement = document.querySelector('.main-wrapper.slide-nav');
    console.log("divElement",divElement)
    const handleSidebarToggle = () => {
        //const htmlElement = document.querySelector('sidebar');
        const divElement = document.querySelector('.main-wrapper');
        const divElement2 = document.querySelector('.main-wrapper.slide-nav');

        console.log("divElement2",divElement2)


        if (divElement.className=='main-wrapper') {
            divElement.className = 'main-wrapper slide-nav';
          }
          else if (divElement.className=='active') {
            divElement.className = 'class="main-wrapper slide-nav"';
          }
          if (divElement2.className=='main-wrapper slide-nav') {
            divElement2.className = 'main-wrapper';
          }
        }
    ...
    <div class="header header-one">
            <div class="header-left header-left-one">
                ...
                <a href="index.html" class="white-logo">
                    <img src="assets/img/logo-white.png" alt="Logo"/>vvvvv
                </a>
            ...
            <a class="mobile_btn" id="mobile_btn" onClick={handleSidebarToggle}>
